...
public class Ens_127_Crear extends Activity {
	...
	TextView tv_m127_super;
	Button bt_m127_crear_perforacion;
	Spinner sp_m127_perforacion;
	Button bt_m127_crear_muestra;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ens_127_crear);

		extra = getIntent().getExtras();
		pro_nombre = extra.getString("pro_nombre");
		ens_numero = extra.getString("ens_numero");

		tv_m127_super = (TextView) findViewById(R.id.tv_m127_super_cre);
		tv_m127_super.setText("Proyecto: " + pro_nombre + "\nEnsayo: "
				+ ens_numero);
		bt_m127_crear_perforacion = (Button) findViewById(R.id.bt_m127_crear_perforacion_cre);
		sp_m127_perforacion = (Spinner) findViewById(R.id.sp_m127_perforacion_cre);
		bt_m127_crear_muestra = (Button) findViewById(R.id.bt_m127_crear_muestra_cre);
		
		ensSQLite = new SQLiteEnsayo(this);
		perSQLite = new SQLitePerforacion(this);
		ens_id = ensSQLite.getEnsayoId(ens_numero, pro_nombre);

		bt_m127_crear_perforacion
				.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						callCrearPerforacion();
						bt_m127_crear_perforacion.setEnabled(false);
					}
				});

		cargarSp();

		bt_m127_crear_muestra.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				callCrearMuestra();
				bt_m127_crear_muestra.setEnabled(false);
			}
		});
	...
	private void cargarSp() {
		...
		sp_m127_perforacion.setAdapter(adapterPerforacion);
	...
	private void callCrearMuestra() {
		Intent intent = new Intent();
		intent.setClass(this, N_INV_127_Crear.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
