...
public class Lab_Perforacion_Consultar extends Activity {
	...
	Button bt_per_consultar;
	Button bt_per_iniciar;
	Bundle extra;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lab_perforacion_consultar);
		...
		bt_per_consultar = (Button) findViewById(R.id.bt_per_consultar);
		bt_per_consultar.setOnClickListener(new View.OnClickListener() {
	...
	private void callLlenarET(int per_Id) {
		...
		per_profundidad.setText(String.valueOf(per.getPerProfundidad()) + " m");
		per_observacion.setText(per.getPerObservacion());
	}

	private void callListaMuestra() {
		Intent intent = new Intent();
		switch (cant_n) {
			case 0:
				intent.setClass(this, Lista_M122.class);
				break;
			case 1:
				intent.setClass(this, Lista_M123.class);
				break;
			case 3:
				intent.setClass(this, Lista_M127.class);
				break;
		}
