...
public class Lista_M1256_HN extends Activity {
	...
	private void cargarLV() {
		list = new ArrayList<String>(mueSQLite.getM1256_HNNumero(per_id));
	...
	public void callMuestraCon(int position) {
		String mue_numero = list.get(position);
			...
			intent.setClass(this, N_INV_1256_HN_Consultar.class);
