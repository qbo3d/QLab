...
public class Puente_Ens_M122 extends Activity {
	...
	private void callEns122Crear() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_122_Crear.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}

	private void callEns122Consultar() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_122_Consultar.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}
