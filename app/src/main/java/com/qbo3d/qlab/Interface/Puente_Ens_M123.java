...
public class Puente_Ens_M123 extends Activity {
	...
	private void callEns123Crear() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_123_Crear.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}

	private void callEns123Consultar() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_123_Consultar.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}
