...
public class Puente_Ens_M127 extends Activity {
	...
	private void callEns127Crear() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_127_Crear.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}

	private void callEns127Consultar() {
		Intent intent = new Intent();
		intent.setClass(this, Ens_127_Consultar.class);
		intent.putExtra("pro_nombre", pro_nombre);
		intent.putExtra("ens_numero", ens_numero);
		startActivity(intent);
	}
